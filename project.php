  ...
  <header>
    ...
    <div class="d-flex justify-content-end">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="116878838_762831931132733_5383408700969080167_n';;,';,[pk,.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">จัดทำโดย</h5>
              <p class="card-text">นายภูวดล น้อยพี </p>
              <p class="card-text"><small class="text-muted">ม.6/13 เลขที่ 11 , 57903</small></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row row-cols-1 row-cols-md-4 mb-3 text-center">
      ...
      <div class="col-3">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title"><?php echo $data[0]->new_case_excludeabroad; ?><small class="text-muted fw-light"> คน</small></h1>
          </div>
        </div>
      </div>
      <div class="col-3">
